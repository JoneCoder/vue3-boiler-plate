    ...
    methods: {
        ...
        callApi(method, url, payload = {}) {
            ...
            try {
                ...
                if(method.toLowerCase() === 'get') loader.params = payload;
                else loader.data = payload;
        ...
        // destroy data
        destroy(model_name, id, search_data) {
            this.root.tableSpinner = true;
